...
void VideoSfMConcurrentClient::authenticate(std::string& _return)
{
  int32_t seqid = send_authenticate();
  recv_authenticate(_return, seqid);
}

int32_t VideoSfMConcurrentClient::send_authenticate()
{
...
void VideoSfMConcurrentClient::recv_authenticate(std::string& _return, const int32_t seqid)
{
...
int32_t VideoSfMConcurrentClient::newSession(const std::string& authToken, const std::vector<double> & camera)
{
  int32_t seqid = send_newSession(authToken, camera);
  return recv_newSession(seqid);
}

int32_t VideoSfMConcurrentClient::send_newSession(const std::string& authToken, const std::vector<double> & camera)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("newSession", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t VideoSfMConcurrentClient::recv_newSession(const int32_t seqid)
{
...
int32_t VideoSfMConcurrentClient::cloneSession(const std::string& authToken, const int32_t oldSessionKey)
{
  int32_t seqid = send_cloneSession(authToken, oldSessionKey);
  return recv_cloneSession(seqid);
}

int32_t VideoSfMConcurrentClient::send_cloneSession(const std::string& authToken, const int32_t oldSessionKey)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("cloneSession", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t VideoSfMConcurrentClient::recv_cloneSession(const int32_t seqid)
{
...
int32_t VideoSfMConcurrentClient::newRsSession(const std::string& authToken, const std::vector<double> & camera, const RollingShutter::type rs, const std::vector<int32_t> & scanlines)
{
  int32_t seqid = send_newRsSession(authToken, camera, rs, scanlines);
  return recv_newRsSession(seqid);
}

int32_t VideoSfMConcurrentClient::send_newRsSession(const std::string& authToken, const std::vector<double> & camera, const RollingShutter::type rs, const std::vector<int32_t> & scanlines)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("newRsSession", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t VideoSfMConcurrentClient::recv_newRsSession(const int32_t seqid)
{
...
int32_t VideoSfMConcurrentClient::newFrame(const std::string& authToken, const int32_t sessionKey, const Frame& frame)
{
  int32_t seqid = send_newFrame(authToken, sessionKey, frame);
  return recv_newFrame(seqid);
}

int32_t VideoSfMConcurrentClient::send_newFrame(const std::string& authToken, const int32_t sessionKey, const Frame& frame)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("newFrame", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t VideoSfMConcurrentClient::recv_newFrame(const int32_t seqid)
{
...
void VideoSfMConcurrentClient::getFrame(Frame& _return, const std::string& authToken, const int32_t sessionKey, const int32_t frameKey)
{
  int32_t seqid = send_getFrame(authToken, sessionKey, frameKey);
  recv_getFrame(_return, seqid);
}

int32_t VideoSfMConcurrentClient::send_getFrame(const std::string& authToken, const int32_t sessionKey, const int32_t frameKey)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getFrame", ::apache::thrift::protocol::T_CALL, cseqid);
...
void VideoSfMConcurrentClient::recv_getFrame(Frame& _return, const int32_t seqid)
{
...
int32_t VideoSfMConcurrentClient::newTrack(const std::string& authToken, const int32_t sessionKey, const Track& track)
{
  int32_t seqid = send_newTrack(authToken, sessionKey, track);
  return recv_newTrack(seqid);
}

int32_t VideoSfMConcurrentClient::send_newTrack(const std::string& authToken, const int32_t sessionKey, const Track& track)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("newTrack", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t VideoSfMConcurrentClient::recv_newTrack(const int32_t seqid)
{
...
void VideoSfMConcurrentClient::getTracks(std::vector<Track> & _return, const std::string& authToken, const int32_t sessionKey)
{
  int32_t seqid = send_getTracks(authToken, sessionKey);
  recv_getTracks(_return, seqid);
}

int32_t VideoSfMConcurrentClient::send_getTracks(const std::string& authToken, const int32_t sessionKey)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getTracks", ::apache::thrift::protocol::T_CALL, cseqid);
...
void VideoSfMConcurrentClient::recv_getTracks(std::vector<Track> & _return, const int32_t seqid)
{
...
void VideoSfMConcurrentClient::initialize(const std::string& authToken, const int32_t sessionKey)
{
  int32_t seqid = send_initialize(authToken, sessionKey);
  recv_initialize(seqid);
}

int32_t VideoSfMConcurrentClient::send_initialize(const std::string& authToken, const int32_t sessionKey)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("initialize", ::apache::thrift::protocol::T_CALL, cseqid);
...
void VideoSfMConcurrentClient::recv_initialize(const int32_t seqid)
{
...
bool VideoSfMConcurrentClient::fullBA(const std::string& authToken, const int32_t sessionKey, const int32_t maxIter, const bool reproject)
{
  int32_t seqid = send_fullBA(authToken, sessionKey, maxIter, reproject);
  return recv_fullBA(seqid);
}

int32_t VideoSfMConcurrentClient::send_fullBA(const std::string& authToken, const int32_t sessionKey, const int32_t maxIter, const bool reproject)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("fullBA", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool VideoSfMConcurrentClient::recv_fullBA(const int32_t seqid)
{
...
bool VideoSfMConcurrentClient::windowedBA(const std::string& authToken, const int32_t sessionKey, const int32_t startFrame, const int32_t endFrame, const int32_t maxIter, const bool reproject)
{
  int32_t seqid = send_windowedBA(authToken, sessionKey, startFrame, endFrame, maxIter, reproject);
  return recv_windowedBA(seqid);
}

int32_t VideoSfMConcurrentClient::send_windowedBA(const std::string& authToken, const int32_t sessionKey, const int32_t startFrame, const int32_t endFrame, const int32_t maxIter, const bool reproject)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("windowedBA", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool VideoSfMConcurrentClient::recv_windowedBA(const int32_t seqid)
{
...
void VideoSfMConcurrentClient::finalize(const std::string& authToken, const int32_t sessionKey)
{
  int32_t seqid = send_finalize(authToken, sessionKey);
  recv_finalize(seqid);
}

int32_t VideoSfMConcurrentClient::send_finalize(const std::string& authToken, const int32_t sessionKey)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("finalize", ::apache::thrift::protocol::T_CALL, cseqid);
...
void VideoSfMConcurrentClient::recv_finalize(const int32_t seqid)
{
